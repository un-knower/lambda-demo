 ...
 */
@Table(keyspace = "demo", name = "register_days_speed_view")
public class RegisterDaysBucketSpeedView implements Serializable {
    ...
    public static RegisterDaysBucketSpeedView valueOf(DimensionDaysBucket dimensionDaysBucket, int registerAmount) {
        final RegisterDaysBucketSpeedView view = new RegisterDaysBucketSpeedView();
