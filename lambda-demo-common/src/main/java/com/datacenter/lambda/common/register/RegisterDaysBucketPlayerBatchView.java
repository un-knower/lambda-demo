 ...
 */
@Table(keyspace = "demo", name = "register_days_player_batch_view")
public class RegisterDaysBucketPlayerBatchView implements Serializable {
    ...
    public static RegisterDaysBucketPlayerBatchView valueOf(DimensionDaysBucket dimensionDaysBucket, long playerId) {
        final RegisterDaysBucketPlayerBatchView view = new RegisterDaysBucketPlayerBatchView();
